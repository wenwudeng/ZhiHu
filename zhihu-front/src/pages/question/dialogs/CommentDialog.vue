      ...
      <el-dialog title="查看评论"
        ...
        <div>
          <div class="dialog-context-header">
            <div class="dialog-context-title">该问题有{{commentList.length}}条评论</div>
          </div>
...
export default {
  props: ['show', 'commentList', 'question_id', 'user_id', 'anonymous'],
  components: {
    'Comment': Comment
  },
  data () {
  ...
  methods: {
    ...
    handleSend: function () {
      let params = {
        commentObjectId: this.question_id, // 问题id
        objectType: '1', // 类型为1--是对问题进行评论
