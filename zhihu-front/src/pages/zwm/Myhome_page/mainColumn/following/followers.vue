     ...
     <span v-if="userList==undefined||userList.length <= 0 ">
          <div class="EmptyState">
            <div class="EmptyState-inner">
                <i class="el-icon-user-solid EmptyState-image" ></i>还没有人关注你喔
            </div>
        </div>
     </span>
</div>
...
import { getConcern } from '../../../../../api/attent.js'
export default {
// import引入的组件需要注入到对象中才能使用
  ...
  data () {
    ...
    //     {
    //       user_name: '影坛XX',
    //       user_avaPic: 'https://pic2.zhimg.com/v2-325169edb5dd682cd6d9212a72950c6b_im.jpg',
    //       user_link: '//www.zhihu.com/people/zhao-si-ji-36',
    //       user_ansNum: '688',
    //       user_artNum: '6',
    //       user_followNum: '17777',
    //       following_statue: '已关注'
    //     }, {
    //       user_name: '迪奥',
    //       user_avaPic: 'https://pic3.zhimg.com/v2-52c06b18b76a25191b91a11873b8828f_im.jpg',
    //       user_link: '//www.zhihu.com/people/zhao-si-ji-36',
    //       user_ansNum: '551',
    //       user_artNum: '3',
    //       user_followNum: '12460',
    //       following_statue: '已关注'
    //     }
    //   ]
    }
